 ...
 */
public class ActivityLoader extends BaseLoader<Activity, IPluginActivity> {
	
	private final String TAG = ActivityLoader.class.getSimpleName();
    ...
    public ActivityLoader(Activity activity) {
    ...
    protected void init(Intent intent) {
        ...
        handleActivityInfo();
		LOG.d(TAG, "1111--- mAssetManager=" + mAssetManager);
    }
    ...
    protected void callPluginOnCreate() {
        ...
        LOG.d(TAG, "callPluginOnCreate() mPlugin = " + mPlugin);
        if (mPlugin != null) {
