/********************************************************************************
 ** File: - BasePluginPreferenceActivity.java
 ** Description: 
 **     Add PreferenceActivity Plugin!
 **     
 ** Version: 1.0
 ** Date: 2015-10-13
 ********************************************************************************/
...
/**
 * Modify for PluginManager using the Application context replace the PreferenceActivity context.
 *
 * @author Nemo.
 * note: can use that like this.
 * All the time use 'that' represents the Proxy PreferenceActivity Context.
 * Cause this method is final, so use that.requestWindowFeature(featureId).
 */

public class BasePluginPreferenceActivity extends PreferenceActivity implements IPluginActivity {
    private static final String TAG = BasePluginPreferenceActivity.class.getSimpleName();

    protected PreferenceActivity mProxyActivity;
    protected PreferenceActivity that;
    ...
    public void attach(Activity proxyActivity, PluginPackage pluginPackage) {
        LOG.d(TAG, "attach: proxyActivity(PreferenceActivity) = " + proxyActivity);
        mProxyActivity = (PreferenceActivity) proxyActivity;
        that = mProxyActivity;
	...
	public PreferenceManager getPreferenceManager() {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            return mProxyActivity.getPreferenceManager();
        }
	}
	...
	public PreferenceScreen getPreferenceScreen() {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            return mProxyActivity.getPreferenceScreen();
        }
	}
	...
	public void setPreferenceScreen(PreferenceScreen preferenceScreen) {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            mProxyActivity.setPreferenceScreen(preferenceScreen);
        }
	}
	...
	public void addPreferencesFromIntent(Intent intent) {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            mProxyActivity.addPreferencesFromIntent(intent);
        }
	}
	...
	public void addPreferencesFromResource(int preferencesResId) {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            mProxyActivity.addPreferencesFromResource(preferencesResId);
        }
	}
	...
	public Preference findPreference(CharSequence key) {
	    if (mFrom == Constants.FROM_INTERNAL) {
            ...
            return mProxyActivity.findPreference(key);
        }
	}
